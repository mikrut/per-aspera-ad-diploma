...
public abstract class ChatsContract {
    ...
    static final String CREATE_TABLE =
            "CREATE TABLE " + ChatsEntry.TABLE_NAME + " (" +
                    ...
                    ChatsEntry.COLUMN_NAME_IMAGE_URL + " TEXT" + COMMA_SEP +
                    ChatsEntry.COLUMN_NAME_MEMBERS_COUNT + " INTEGER NOT NULL" +
                    ")";
    ...
    static final String[] CHAT_PROJECTION = {
            ...
            ChatsEntry.COLUMN_NAME_MEMBERS_COUNT
    };
    ...
    public static final int PROJECTION_DATETIME_INDEX = 3;
    public static final int PROJECTION_TYPE_INDEX = 4;
    public static final int PROJECTION_IMAGE_URL_INDEX = 5;
    public static final int PROJECTION_MEMBERS_COUNT_INDEX = 6;
    ...
    public static abstract class ChatsEntry implements BaseColumns {
        ...
        public static final String COLUMN_NAME_MEMBERS_COUNT = "members_count";
    }
}
